...
proc write_mig_file_design_1_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {    <MemoryDevice>DDR3_SDRAM/Components/MT41K64M16XX-15E</MemoryDevice>}
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net pmodIf_0_axi_periph_M03_AXI [get_bd_intf_pins mig_7series_0/S_AXI] [get_bd_intf_pins pmodIf_0_axi_periph/M03_AXI]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins pmodIf_0_axi_periph/M03_ACLK] [get_bd_pins rst_mig_7series_0_83M/slowest_sync_clk]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz/resetn] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins rst_clk_wiz_100M/ext_reset_in]
  ...
  connect_bd_net -net rst_mig_7series_0_83M_peripheral_aresetn [get_bd_pins mig_7series_0/aresetn] [get_bd_pins pmodIf_0_axi_periph/M03_ARESETN] [get_bd_pins rst_mig_7series_0_83M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x80000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces pmodIf_0/M_AXI] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
